...
ActiveRecord::Schema.define(version: 20181025204732) do
  ...
  create_table "incidents", force: :cascade do |t|
    ...
    t.datetime "created_at",      null: false
    t.datetime "updated_at",      null: false
    t.index ["client_event_id"], name: "index_incidents_on_client_event_id", using: :btree
  end
  ...
  add_foreign_key "incidents", "client_events"
end
