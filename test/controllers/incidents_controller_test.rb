...
class IncidentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create incident" do
    assert_difference('Incident.count') do
      post incidents_url, params: { incident: { client_event_id: @incident.client_event_id, description: @incident.description } }
    end
  ...
  test "should update incident" do
    patch incident_url(@incident), params: { incident: { client_event_id: @incident.client_event_id, description: @incident.description } }
